...
namespace UserLogin.App {
    ...
    public partial class DataSet : global::System.Data.DataSet {
        ...
        public partial class UserDataTable : global::System.Data.TypedTableBase<UserRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public UserRow AddUserRow(string Username, string Password, string Firstname, string Lastname, string Email, string Address, byte[] Image, string Comment, string Contact) {
...
namespace UserLogin.App.DataSetTableAdapters {
    ...
    public partial class UserTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [User] ([Username], [Password], [Firstname], [Lastname], [Email], [Address], [Image], [Comment], [Contact]) VALUES (@Username, @Password, @Firstname, @Lastname, @Email, @Address, @Image, @Comment, @Contact);
SELECT UserId, Username, Password, Firstname, Lastname, Email, Address, Image, Comment, Contact FROM [User] WHERE (UserId = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [User] SET [Username] = @Username, [Password] = @Password, [Firstname] = @Firstname, [Lastname] = @Lastname, [Email] = @Email, [Address] = @Address, [Image] = @Image, [Comment] = @Comment, [Contact] = @Contact WHERE (([UserId] = @Original_UserId) AND ((@IsNull_Username = 1 AND [Username] IS NULL) OR ([Username] = @Original_Username)) AND ((@IsNull_Password = 1 AND [Password] IS NULL) OR ([Password] = @Original_Password)) AND ((@IsNull_Firstname = 1 AND [Firstname] IS NULL) OR ([Firstname] = @Original_Firstname)) AND ((@IsNull_Lastname = 1 AND [Lastname] IS NULL) OR ([Lastname] = @Original_Lastname)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_Address = 1 AND [Address] IS NULL) OR ([Address] = @Original_Address)) AND ((@IsNull_Comment = 1 AND [Comment] IS NULL) OR ([Comment] = @Original_Comment)) AND ((@IsNull_Contact = 1 AND [Contact] IS NULL) OR ([Contact] = @Original_Contact)));
SELECT UserId, Username, Password, Firstname, Lastname, Email, Address, Image, Comment, Contact FROM [User] WHERE (UserId = @UserId)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::UserLogin.App.Properties.Settings.Default.LoginUsersConnectionString1;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT        UserId, Username, Password, Firstname, Lastname, Email, Address, Im" +
                "age, Comment, Contact\r\nFROM            [User]";
        ...
        public virtual int Delete(int Original_UserId, string Original_Username, string Original_Password, string Original_Firstname, string Original_Lastname, string Original_Email, string Original_Address, string Original_Comment, string Original_Contact) {
        ...
        public virtual int Insert(string Username, string Password, string Firstname, string Lastname, string Email, string Address, byte[] Image, string Comment, string Contact) {
            if ((Username == null)) {
        ...
        public virtual int Update(
                    ...
                    string Original_Comment, 
                    string Original_Contact) {
            return this.Update(Username, Password, Firstname, Lastname, Email, Address, Image, Comment, Contact, Original_UserId, Original_Username, Original_Password, Original_Firstname, Original_Lastname, Original_Email, Original_Address, Original_Comment, Original_Contact, Original_UserId);
        }
    }
